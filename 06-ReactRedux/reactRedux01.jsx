 ...
 *
 * React is a view library that you provide with data, then it renders the view in an efficient,
 * predictable way.
 *
 ...
 *
 * Finally, because Redux is not designed to work with React out of the box, you need to use the
 * react-redux package.
 *
 * It provides a way for you to pass Redux state and dispatch to your React components as props.
 *
 * Over the next few challenges, first, you'll create a simple React component which allows you to input
 * new text messages.
 *
 ...
 *
 * Finally, you'll use react-redux to connect the Redux store with your component, thereby extracting
 * the local state into the Redux store.
 *
 * Start with a DisplayMessages component. Add a constructor to this component and initialize it
 * with a state that has two properties: input, that's set to an empty string, and messages,
