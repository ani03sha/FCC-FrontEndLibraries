 ...
 * state into Redux.
 *
 * This is the first step to connect the simple React app to Redux. The only functionality your app has
 * is to add new messages from the user to an unordered list.
 *
 ...
 *
 * The initial state should equal an empty array. This reducer should add a message to the array
