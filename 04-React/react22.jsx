 ...
 *
 * If you want to access a state value within the return of the render method, you have to enclose the
 ...
 *
 * When state data updates, it triggers a re-render of the components using that data - including child
 * components that received the data as a prop.
 *
 ...
 *
 * Its state is completely encapsulated, or local to that component, unless you pass state data to a
