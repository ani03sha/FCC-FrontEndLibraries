 ...
 *
 * You can compare the current props (this.props) to the next props (nextProps) to determine if you
 * need to update or not, and return true or false accordingly.
 *
 ...
 *
 * Click the Add button and watch the order of events in your browser's console as the other
