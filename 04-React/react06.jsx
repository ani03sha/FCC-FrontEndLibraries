/**
 * So far, you’ve seen how JSX differs from HTML in a key way with the use of className vs. class for
 * defining HTML classes.
 *
 ...
 *
 * However, there are special instances in HTML called “self-closing tags”, or tags that don’t
 * require both an opening and closing tag before another tag can start.
 *
 * For example the line-break tag can be written as <br> or as <br />, but should never be written
 * as <br></br>, since it doesn't contain any content.
 *
 * In JSX, the rules are a little different.
 *
 * Any JSX element can be written with a self-closing tag, and every element must be closed.
 *
 * The line-break tag, for example, must always be written as <br /> in order to be valid JSX that
 * can be transpiled.
 *
