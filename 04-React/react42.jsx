/**
 * Before moving on to dynamic rendering techniques, there's one last way to use built-in JavaScript
 * conditionals to render what you want: the ternary operator.
 *
 * The ternary operator is often utilized as a shortcut for if/else statements in JavaScript.
 *
 * They're not quite as robust as traditional if/else statements, but they are very popular among
 * React developers.
 *
 * One reason for this is because of how JSX is compiled, if/else statements can't be inserted directly
 * into JSX code.
 *
 * You might have noticed this a couple challenges ago — when an if/else statement was required, it was always
 * outside the return statement.
 *
 * Ternary expressions can be an excellent alternative if you want to implement conditional logic
 * within your JSX.
 *
 ...
 * expression representing a button element.
 *
 ...
 *
 * If a user enters a number less than 18, render buttonThree. If a user enters a number greater than
 * or equal to 18, render buttonTwo.
 *
 */
