 ...
 *
 * But you may be wondering about the more simple problem of how to style those JSX elements you create
 * in React.
 *
 * You likely know that it won't be exactly the same as working with HTML because of the way you apply
 * classes to JSX elements.
 *
 * If you import styles from a stylesheet, it isn't much different at all.
 *
 * You apply a class to your JSX element using the className attribute, and apply styles to the class
 * in your stylesheet.
 *
 ...
 *
 * Notice how we camelCase the "fontSize" property? This is because React will not accept kebab-case
 * keys in the style object.
 *
 * React will apply the correct property name for us in the HTML.
 *
 * Add a style attribute to the div in the code editor to give the text a color of red and font size of 72px.
 *
 * Note that you can optionally set the font size to be a number, omitting the units "px", or write
 * it as "72px".
 *
 */
