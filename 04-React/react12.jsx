 ...
 *
 * The past few challenges focused on components and composition, so the rendering was done for you behind
 * the scenes.
 *
 ...
 *
 * However, for React components, you need to use the same syntax as if you were rendering a nested
 * component, for example ReactDOM.render(<ComponentToRender />, targetNode).
 *
