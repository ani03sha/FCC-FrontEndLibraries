 ...
 *
 * First, without doing this, your React apps would consist of a relatively empty HTML file and a
 * large bundle of JavaScript when it's initially loaded to the browser.
 *
 * This may not be ideal for search engines that are trying to index the content of your pages so people
 * can find you.
 *
 * If you render the initial HTML markup on the server and send this to the client, the initial page
