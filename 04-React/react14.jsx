 ...
 * and ES6 style class components in React.
 *
 * With this foundation, it's time to look at another feature very common in React: props.
 *
 * In React, you can pass props, or properties, to child components.
 *
 * Say you have an App component which renders a child component called Welcome that is a stateless
 ...
 * </App>
 *
 *  You use custom HTML attributes that React provides support for to pass the property user to the
 * component Welcome.
 *
 ...
 *
 * When rendering CurrentDate from the Calendar component, pass in a property of date assigned to the
 * current date from JavaScript's Date object.
 *
