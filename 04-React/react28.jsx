 ...
 *
 * For example, form control elements for text input, such as input and textarea, maintain their
 * own state in the DOM as the user types.
 *
 ...
 *
 * Typically, if you have React components with input fields the user can type into, it will be a
 ...
 *
 * When you type in the input box, that text is processed by the handleChange() method, set as the
