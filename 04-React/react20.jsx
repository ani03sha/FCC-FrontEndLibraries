 ...
 * internal state (covered in the next challenge).
 *
 ...
 *
 * Inside the Camper component, render any code that you want, but make sure to have one p element that
 * includes only the name value that is passed in as a prop.
 *
 * Finally, define propTypes on the Camper component to require name to be provided as a prop and verify
