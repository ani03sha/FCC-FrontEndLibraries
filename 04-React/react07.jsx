 ...
 *
 * For now, think of a stateless component as one that can receive data and render it, but does not
 * manage or track changes to that data.
 * (We'll cover the second way to create a React component in the next challenge.)
 *
 * To create a component with a function, you simply write a JavaScript function that returns either
 * JSX or null.
 *
 ...
 * };
 *
 * Because a JSX component represents HTML, you could put several components together to create a
 * more complex HTML page.
 *
 ...
 *
 * The code editor has a function called MyComponent. Complete this function so it returns a single
