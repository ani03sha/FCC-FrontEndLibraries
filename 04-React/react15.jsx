/**
 * The last challenge demonstrated how to pass information from a parent component to a child component
 * as props or properties.
 *
  ...
  render() {
    return (
      <div>
        <h1>To Do Lists</h1>
        <h2>Today</h2>
        <List tasks={["Code", "Sleep"]} />
        <h2>Tomorrow</h2>
        <List tasks={["Code", "Sleep", "Drink Coffee"]} />
      </div>
    );
  }
}
