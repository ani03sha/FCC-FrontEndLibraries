 ...
 * 
 * For example, you could declare functions, access data from state or props, perform computations on 
 * this data, and so on. 
 * 
 ...
 * 
 * Because you can write JavaScript directly in this part of the code, you don't have to enclose this 
